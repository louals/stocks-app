...
import { checkIfInWatchlist } from "@/lib/actions/watchlist";
import {
...
export default async function StockDetails({ params }: StockDetailsPageProps) {
  ...
  const isInWatchlist = await checkIfInWatchlist(symbol);
          ...
          <div className="flex items-center justify-between bg-gray-800 p-4 rounded-lg shadow">
            <div className="flex items-center gap-4">
              ...
              <span className="text-gray-100">
                {isInWatchlist ? 'In your watchlist' : 'Not in watchlist'}
              </span>
            </div>
            <WatchlistButton 
              symbol={symbol.toUpperCase()} 
